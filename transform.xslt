<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="header">
		...
		<xsl:call-template name="header_exam">
			<xsl:with-param name="exam_number" select="1" />
		</xsl:call-template>
    <xsl:call-template name="header_exam">
      <xsl:with-param name="exam_number" select="2" />
    </xsl:call-template>
		<xsl:text>"spare"</xsl:text>
		<xsl:text>&#xa;</xsl:text>
	</xsl:template>

  <xsl:template name="header_exam">
    ...
    <xsl:call-template name="header_exam_field">
      <xsl:with-param name="exam_number" select = "$exam_number" />
      <xsl:with-param name="field_name" select = "'id'" />
    </xsl:call-template>
    <xsl:call-template name="header_exam_field">
      <xsl:with-param name="exam_number" select = "$exam_number" />
    ...
    <xsl:call-template name="header_test">
      <xsl:with-param name="exam_number" select = "$exam_number" />
      <xsl:with-param name="test_number" select = "5" />
    </xsl:call-template>
    <xsl:call-template name="header_test">
      <xsl:with-param name="exam_number" select = "$exam_number" />
  ...
  <xsl:call-template name="header_result">
	...
	<xsl:template name="Test" >
		...
		<xsl:apply-templates select="$test/test_type/test_title" mode="string" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$test/test_type/stage" mode="string" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$test/test_type/best_test" mode="string" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$test/test_type/manual_best" mode="string" />
    <xsl:text>,</xsl:text>
    <xsl:apply-templates select="$test/test_type/composite_test" mode="string" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$test/index" mode="numeric" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$test/date_time" mode="datetime" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$test/sensor_type" mode="string" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$test/excluded" mode="string" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$test/best_criteria" mode="string" />
		<xsl:text>,</xsl:text>
  ...
  <xsl:call-template name="Result">
	...
	<xsl:template match="patient">
		...
		<xsl:call-template name="Exam">
			<xsl:with-param name="exam" select="exam[position() = 1]" />
		</xsl:call-template>
    <xsl:call-template name="Exam">
      <xsl:with-param name="exam" select="exam[position() = 2]" />
    </xsl:call-template>
	...
	<xsl:template name="Exam" >
		...
		<xsl:apply-templates select="$exam/type" mode="string" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$exam/new" mode="string" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$exam/exam_id" mode="string" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$exam/date_time" mode="datetime" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$exam/notes" mode="string" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$exam/reproducibility/test_title" mode="string" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$exam/reproducibility/stage" mode="string" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$exam/reproducibility/reproducibility_title" mode="string" />
    <xsl:text>,</xsl:text>
    <xsl:apply-templates select="$exam/reproducibility/reproducibility_value" mode="string" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$exam/reproducibility/reproducibility_message" mode="string" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$exam/interpretation/stage" mode="string" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$exam/interpretation/title" mode="string" />
		<xsl:text>,</xsl:text>
	...
	<xsl:template name="Result" >
		...
		<xsl:apply-templates select="$test/result[title=$title]/value" mode="numeric" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$test/result[title=$title]/unit_symbol" mode="string" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$test/result[title=$title]/predicted_value" mode="numeric" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$test/result[title=$title]/predicted_value_min" mode="numeric" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$test/result[title=$title]/predicted_value_max" mode="numeric" />
		<xsl:text>,</xsl:text>
		<xsl:apply-templates select="$test/result[title=$title]/z_score" mode="numeric" />
		<xsl:text>,</xsl:text>
	</xsl:template>
